...
int main(int argc, char *argv[])
{
	...
	printf("***LINE 23: MyMalloc(4,194,304)***\n");
	ptr[0] = MyMalloc(size);
	if(ptr[0] == NULL)
	{
	...
	printf("***LINE 35: MyMalloc(4,194,304)***\n");
	ptr[1] = MyMalloc(size);
	if(ptr[1] == NULL)
	{
	...
	printf("***LINE 48: MyMalloc(4,194,304)***\n");
	ptr[2] = MyMalloc(size);
	if(ptr[2] == NULL)
	{
	...
	printf("***LINE 64: MyMalloc(4,194,304)***\n");
	ptr[3] = MyMalloc(size);
	if(ptr[3] == NULL)
	{
...
\	 */
	 ...
	 */
	printf("***LINE 115: ALLOCATING / SPLITTING A1***\n");
	 ...
	 */
	printf("***LINE 129: FREE 1ST BLOCK AND HALF OF 2ND***\n");
	MyFree(ptr[0]);
	MyFree(ptr[1]);
	 ...
	 */
	printf("***LINE 140: NO SPLIT SHOULD OCCUR***\n");
	 ...
	 */
	printf("***LINE 154: RE-FREE FIRST BLOCK***\n");
	MyFree(ptr[0]);
